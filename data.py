...
exlist = {'Abhishek': 'Information Tech', 'Sam': 'Mechanical', 'Jack': 'Computer', 'Erik': 'Electronics',
          'john': 'Robotics',
          'Mayur': 'Information Tech', 'Akshay': 'Robotics', 'Bhavesh': 'Computer', 'Sameer': 'Electronics',
          'Sagar': 'Robotics'}
...
labb = Label(root, text='Results', font=('none 18 bold'))
